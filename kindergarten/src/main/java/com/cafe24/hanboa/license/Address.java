...
public class Address {
	...
	public String toString() {
		return "Address [roadFullAddr=" + roadFullAddr + ", roadAddrPart1=" + roadAddrPart1 + ", roadAddrPart2="
				+ roadAddrPart2 + ", jibunAddr=" + jibunAddr + ", engAddr=" + engAddr + ", zipNo=" + zipNo
				+ ", addrDetail=" + addrDetail + ", admCd=" + admCd + ", rnMgtSn=" + rnMgtSn + ", bdMgtSn=" + bdMgtSn
