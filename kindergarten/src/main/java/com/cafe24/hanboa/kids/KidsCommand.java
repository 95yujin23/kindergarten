...
public class KidsCommand {
	...
	public String toString() {
		return "KidsCommand [kidsCd=" + kidsCd + ", kidsNm=" + kidsNm + ", kidsDateOfBirth=" + kidsDateOfBirth
				...
				+ kidsGraduation + ", licenseKindergarten=" + licenseKindergarten + ", file=" + file + "]";
	}
}
