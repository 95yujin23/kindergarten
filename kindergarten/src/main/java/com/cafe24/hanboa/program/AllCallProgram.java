...
public class AllCallProgram {
	...
	public String toString() {
		return "AllCallProgram [programCd=" + programCd + ", totalResourceCd=" + totalResourceCd + ", programNm="
				+ programNm + ", programNumberWeek=" + programNumberWeek + ", programOperationTime="
				+ programOperationTime + ", programOutsourcingCost=" + programOutsourcingCost + ", programClosingCd="
				+ programClosingCd + ", programClosingDivision=" + programClosingDivision + ", contractCd=" + contractCd
				+ ", programRegistrationDate=" + programRegistrationDate + ", programRegistrant=" + programRegistrant
				+ ", licenseKindergarten=" + licenseKindergarten + ", resourceNm=" + resourceNm + ", contractContents="
				+ contractContents + "]";
	}
}
