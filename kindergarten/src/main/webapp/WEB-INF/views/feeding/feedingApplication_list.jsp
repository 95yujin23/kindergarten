...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			...
			<h1 class="page-header">급식신청 목록</h1>
			</div>
					...
					<ul class="pagination justify-content-center">
						...
						<c:choose>
							<c:when test="${currentPage eq 1}">
								<li class="page-item">
									<a class="page-link" href="${pageContext.request.contextPath}/FeedingApplicationList?currentPage=${currentPage}" aria-label="Previous">
							...
							<c:when test="${currentPage ne 1}">
								<li class="page-item">
									<a class="page-link" href="${pageContext.request.contextPath}/FeedingApplicationList?currentPage=${currentPage-1}" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
									<span class="sr-only">Previous</span>
									</a>
								</li>
						...
						<c:forEach var="i" begin="1" end="${countPage}" step="1">
							<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/FeedingApplicationList?currentPage=${i}">
									${i}
								</a>
							</li>
						</c:forEach>
						<c:choose>
							<c:when test="${currentPage eq countPage}">
								<li class="page-item">
									<a class="page-link" href="${pageContext.request.contextPath}/FeedingApplicationList?currentPage=${currentPage}" aria-label="Next">
							...
							<c:when test="${currentPage ne countPage}">
								<li class="page-item">
									<a class="page-link" href="${pageContext.request.contextPath}/FeedingApplicationList?currentPage=${currentPage+1}" aria-label="Next">
										<span aria-hidden="true">&raquo;</span>
										<span class="sr-only">Next</span>
									</a>
								</li>
...
<script src="resources/vendor/js/sb-admin-2.js"></script>
	...
	$(document).ready(function(){
	  $("#search").on("keyup", function() {
	    ...
	    $("#feedingApplicationTable tr").filter(function() {
